...
def escribir(evento):
    txtNew= evento.widget.cget("text")
    if txtNew=="." and "." in pantalla.get():
        pass
    else:
        pantalla.insert(END, txtNew)
    
def escribirOpera(evento):
    txtNew= evento.widget.cget("text")
    global num1
...
def operar(evento):
    num2 = float(pantalla.get()[1:])
    ope = pantalla.get()[:1]
    pantalla.delete(0,END)
    if ope == "+":
        pantalla.insert(END, (str(num1+float(num2))))
    elif ope == "-":
        pantalla.insert(END, (str(num1-float(num2))))
    elif ope == "/":
        pantalla.insert(END, (str(num1/float(num2))))
...
boton_1.bind("<Button-1>",escribir)
boton_2.bind("<Button-1>",escribir)
boton_3.bind("<Button-1>",escribir)
boton_4.bind("<Button-1>",escribir)
boton_5.bind("<Button-1>",escribir)
boton_6.bind("<Button-1>",escribir)
boton_7.bind("<Button-1>",escribir)
boton_8.bind("<Button-1>",escribir)
boton_9.bind("<Button-1>",escribir)
boton_punto.bind("<Button-1>",escribir)

boton_mas.bind("<Button-1>",escribirOpera)
boton_menos.bind("<Button-1>",escribirOpera)
boton_multiplicacion.bind("<Button-1>",escribirOpera)
boton_division.bind("<Button-1>",escribirOpera)

boton_igual.bind("<Button-1>",operar)
